...
5. **ホスティング**：[hfu/stars#7](https://github.com/hfu/stars/pull/7) で `config/martin.yaml` に登録。`https://stars.optgeo.org/glup2030_zoning/{z}/{x}/{y}` として配信（height-coverageの `overture_buildings` と同じMartin経由のパターン）。
